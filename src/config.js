...
exports.picurl = 'http://localhost:3000'
exports.fetchState = {
  success: 'success'
}
...
exports.JRStatus = {
  toSubmit: 'toSubmit', // JR 已创建，待提交（创建）
  refusedByPE: 'refusedByPE', // PE 已拒绝，待编辑并提交（PE 拒绝）
  toApproveByAD: 'toApproveByAD', // 已提交，待客户总监审批（提交、编辑并提交）
  refusedByAD: 'refusedByAD', // 客户总监已拒绝，待提交（客户总监拒绝）
  toApproveByFinance: 'toApproveByFinance', // 客户总监已批准，待财务审批（客户总监批准）
  refusedByFinance: 'refusedByFinance', // 财务已拒绝，待提交（财务拒绝）
  toApproveByFM: 'toApproveByFM', // 财务已批准。1.  create 模式 => 直接变更为已生效；2. update/abandon => 下一步待财务经理审批
  refusedByFM: 'refusedByFM', // 财务经理已拒绝，待提交（财务经理拒绝）
  effective: 'effective', // 已生效。1. 财务已批准，变更为生效；2. 财务经理批准，变更为生效
  abandoned: 'abandoned' // 已废弃
}

exports.PEStatus = {
  toSubmit: 'toSubmit', // PE 已创建，待 traffic 人员提交（录入 code）
  toUpdate: 'toUpdate', // 待 traffic 人员修改（JR 编辑审批通过）
  toFinanceAbandon: 'toFinanceAbandon', // 待财务人员废弃（JR 废弃审批通过）
  toAbandonVPO: 'toAbandonVPO', // 待废弃 vpo
  toApproveByFM: 'toApproveByFM', // 已提交，待财务经理审批（提交）
  refusedByFM: 'refusedByFM', // 财务经理已拒绝，待 JR 编辑（财务经理拒绝）
  toApproveByAD: 'toApproveByAD', // 财务经理已批准，待客户总监审批（财务经理批准）
  refusedByAD: 'refusedByAD', // 客户总监已拒绝，待 JR 编辑（客户总监拒绝）
  toSendToClient: 'toSendToClient', // 客户总监已批准，待 PE 文件发送给客户（客户总监批准）
  toApproveByClient: 'toApproveByClient', // 已发送给客户，待客户审批（发送给客户）
  refusedByClient: 'refusedByClient', // 客户拒绝，待 JR 编辑（客户拒绝）
  toApproveByFinance: 'toApproveByFinance', // 客户已批准，待财务审批（客户批准，同时上传客户审批书）
  refusedByFinance: 'refusedByFinance', // 财务已拒绝，待客户审批（财务拒绝）
  running: 'running', // 财务已批准，运行中
  completing: 'completing', // 结束中
  completed: 'completed', // PE 已结束（财务点击结束）
  abandoned: 'abandoned', // 已废弃（财务废弃）
  pausing: 'pausing' // 暂停中
}
...
// vendor Type 供应商类别
exports.vendorTypeArr = ['Freelancer', 'NonRegularVendor', 'RegularVendor', 'ContractVendor', 'TaxBureau']
...
export const payment_tableField = {
  flowStatus: 'flowStatus',
  INVDate: 'INVDate',
  num: 'num',
  vpoCode: 'vpoCode',
  ...
  vendorFPNum: 'vendorFPNum',
  accountNum: 'accountNum',
  peCode: 'peCode'
}

export const jobCompletion_tableField = {
  status: 'flowStatus',
  peCode: 'code',
  description: 'description',
  currency: 'currencyId',
...
export const raiseInv_tableField = {
  id:'id',
  peCode:'peCode',
  description:'description',
  currency:'currencyId',
