...
export const NEW_PLACED_TO = 'NEW_PLACED_TO';
export const ALT_PLACED_TO = 'ALT_PLACED_TO'
export const FETCH_PLACED_TO_INFO = 'FETCH_PLACED_TO_INFO'
...
const ACTION_HANDLERS = {
  ...
  [FETCH_PLACED_TO_INFO] :(state, action) => state.update('placedToInfo',() =>Immutable.fromJS(action.payload))
};
