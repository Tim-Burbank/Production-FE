...
export const updateTier1= (id,json) => {
  return (dispatch, getState) => {
...
export const deleteTier1= (id) => {
  return (dispatch, getState) => {
    return easyfetch(host,'/tier1s/'+id,'delete')
      .then(
        e=>{
          return dispatch(fetchTier1())
        }
...
export const newTier2= (json) => {
  return (dispatch, getState) => {
    return easyfetch(host,'/tier2s','post',json)
      .then(
        e=>{
          return dispatch(fetchTier1())
        }
...
export const deleteTier2= (id) => {
  return (dispatch, getState) => {
    return easyfetch(host,'/tier2s/'+id,'delete')
      .then(
        e=>{
          return dispatch(fetchTier1())
        }
